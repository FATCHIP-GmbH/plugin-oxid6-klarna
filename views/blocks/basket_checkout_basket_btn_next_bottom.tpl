[{$smarty.block.parent}]
[{block name="checkout_basket_btn_bottom_klarnaexpress"}]
    [{if $oViewConf->getActiveClassName() == 'basket' && $oViewConf->isKlarnaPaymentsEnabled() && $oViewConf->displayExpressButtonInBasket()}]
        [{block name="checkout_basket_btn_bottom_klarnaexpress_spacer"}]
