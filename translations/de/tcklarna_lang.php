...
$aLang = array(
    ...
    "TCKLARNA_RESET_COUNTRY" => "Ihr Land: <strong>%s</strong> ",
    "TCKLARNA_CHANGE_COUNTRY" => "ändern",
    "TCKLARNA_LOGIN_INTO_AMAZON" => "Bitte klicken Sie auf diesen Button, um den Login mit Amazon zu starten",
    ...
    "TCKLARNA_PAYPAL_EXPRESS_SESSION_KILLED" => "Ihr PayPal-Zahlvorgang wurde abgebrochen. Es wurde kein Geld von PayPal eingezogen.",
    ...
    "TCKLARNA_AUTHPAYMENTMETHOD_bank_transfer" => "Klarna Überweisung",
    "TCKLARNA_AUTHPAYMENTMETHOD_card" => "Kreditkarte",
    "TCKLARNA_AUTHPAYMENTMETHOD_fixed_amount" => "Klarna Finanzierung",
    "TCKLARNA_AUTHPAYMENTMETHOD_invoice_business" => "Klarna B2B Rechnung (Billie)",
